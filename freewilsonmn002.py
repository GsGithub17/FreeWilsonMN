...
if uploaded_file is not None:
    ...
    if not all(col in df.columns for col in required_columns):
        st.error("CSV file must contain at least the 'SMILES' and 'Activity' columns.")
    else:
        ...
        # =====================================================
        # Molecule Networks Section (original code remains unchanged)
        # =====================================================
            ...
            **Concept:**  
            ...
            for idx, row in df.iterrows():
                ...
                nt.add_node(idx, label=label, title=f"SMILES: {row['SMILES']}<br>Potency: {row['Activity']}")
            for edge in edges:
